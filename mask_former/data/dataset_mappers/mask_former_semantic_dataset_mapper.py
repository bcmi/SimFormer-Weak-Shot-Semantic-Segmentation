...
class MaskFormerSemanticDatasetMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        if self.cfg.PSEUDO_LABEL_PATH == 'none':
            ...
            sem_seg_gt = utils.read_image(label_path).astype("double")
        ...
        # 'datasets/coco/coco_stuff_10k/images_detectron2/train/COCO_train2014_000000350361.jpg'

        if dataset_dict[
            'file_name'] == 'datasets/coco/coco_stuff_10k/images_detectron2/train/COCO_train2014_000000038905.jpg':
            d = 1
