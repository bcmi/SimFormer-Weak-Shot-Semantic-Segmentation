...
from mask_former.modeling.heads.pixel_decoder import build_pixel_decoder
from .prop_transformer_predictor import PropTransformerPredictor

@SEM_SEG_HEADS_REGISTRY.register()
class PropFormerHead(nn.Module):
    _version = 2
